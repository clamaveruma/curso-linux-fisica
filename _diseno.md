...
- **E2. Antigravity CLI de Google** *(añadido 2026-08-28 a petición de Claudio)*: instalar el CLI gratuito con cuenta de Google (guion oficial `curl … | bash`, enseñado con la disciplina descargar-leer-ejecutar; consejo: preguntar a una IA o a la web de Google cómo instalarlo, porque cambia), configurarlo desde el principio para que proponga y explique comandos sin ejecutarlos (modo «pedir confirmación» + instrucción de aprendizaje), la analogía del fontanero que enseña frente al que arregla; Gemini CLI como variante solo terminal.
