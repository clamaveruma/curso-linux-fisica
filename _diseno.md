...
- **E2. Antigravity de Google** *(añadido 2026-08-28 a petición de Claudio)*: instalar el agente gratuito con cuenta de Google, configurarlo desde el principio para que proponga y explique comandos sin ejecutarlos (modo «pedir confirmación» + instrucción de aprendizaje), la analogía del fontanero que enseña frente al que arregla; Gemini CLI como variante solo terminal.
