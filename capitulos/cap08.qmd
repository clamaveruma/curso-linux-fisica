...
que todavía no sabes leer. El bloque D empieza ahí: qué es una
dirección IP, qué es esa máscara `/24`, quién reparte las direcciones
en tu casa — y la expedición al router de la compañía, en modo solo
lectura, para hacer el censo de todos los aparatos que viven en tu
red. Guarda `sesion08.log`: bloque C completo.
:::
