...
::: {.lede}
El ensayo general. Durante doce sesiones cada pieza vino con su
...
**3. La red** *(capítulos 9 y 10)*. Averigua la IP del servidor,
...
**4. El acceso** *(capítulo 11)*. Tu clave pública en el servidor,
...
**8. La recogida** *(capítulo 11)*. Trae `resultados/` a tu Mint con
`rsync`, y abre el informe. Repite el `rsync`: debe no transferir
nada.

**9. Propina** *(capítulo 12)*. Jupyter en el servidor a través de un
