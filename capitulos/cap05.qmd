...
![La vida de un proceso. Nace del shell, corre en primer o segundo plano, y termina cuando acaba — o cuando una señal se lo pide.](../imagenes/cap05/fig-procesos.svg){#fig-procesos fig-alt="Un proceso lanzado por el shell, con las señales SIGINT, SIGTERM y SIGKILL llegando a él, y su terminación"}
...
plato fuerte del capítulo 13. El `&` de hoy es su semilla.
...
El capítulo 6 es el último del bloque B y el que abre la puerta a
todo lo demás: verás discos y particiones — `lsblk`, montar y
desmontar, qué es esa partición EFI — y la película completa de lo que
pasa entre el botón de encendido y tu escritorio: UEFI, GRUB, kernel.
Es el prerrequisito
