...
de medidas inservible y ficheros temporales. (Los ficheros se llaman
`run…`: es la jerga del laboratorio para cada serie de medidas, y así
la verás en cualquier grupo.) Tu misión: dejarlo presentable usando
todo lo de esta sesión.
