...
- Qué es un clúster de cálculo y dónde seguir el día que te den cuenta en uno.
:::
...
## Cuando te den cuenta en un clúster {#sec-cluster}
...
investigadores por una **cola de trabajos**. Se entra por SSH (este
bloque entero aplica), se prepara el trabajo en una máquina de
recepción y se le *pide* a la cola que lo ejecute cuando haya hueco.
El gestor de colas más común se llama **SLURM**, y su manual de dos
páginas — anatomía del clúster, el *job script*, enviar, consultar y
cancelar — está en el [anexo E2](../anexos/anexo-e2-slurm.qmd), para
el día en que te den el usuario. Hoy no hace falta: con `tmux` y el
túnel ya tienes el noventa por ciento de lo que harás allí.
...
herramienta y no como oráculo, el camino para quien venga de Windows
— y SLURM, para el día del clúster. Guarda
