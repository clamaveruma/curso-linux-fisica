...
::: {.chapmeta}
⏱ **2 h** (lo esencial) · requisitos: **capítulo 11** · máquina: **tu Linux de diario y `debian-lab`** · nivel: **avanzado — para conocer**
:::
...
::: {.solucion-final}
**Autocomprobación (test de la sección 12.8)** — Respuestas: 1 b · 2 b · 3 b · 4 a · 5 a · 6 a.
:::
