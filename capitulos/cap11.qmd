...
::: {.chapmeta}
⏱ **2–3 h** con ejercicios · requisitos: **capítulos 8 y 10** · máquina: **tu Linux de diario y `debian-lab`**
:::
...
::: {.truco}
**✚ Truco · Arrastrar y soltar por SSH**

El gestor de archivos de Mint sabe hablar SSH: en la barra de
direcciones (<kbd>Ctrl</kbd>+<kbd>L</kbd>) escribe
`sftp://debian-lab/home/marcos` y verás la casa del servidor como una
carpeta más — arrastra ficheros, ábrelos, edítalos. Es SFTP, el
primo de `scp` que viaja por el mismo túnel. Para un fichero suelto
es perfecto; `rsync` gana cuando son mil ficheros o hay que repetir
la copia cada día.
:::
...
| Vía | Qué es | Coste |
|-----|--------|-------|
| **Cuenta de la universidad** | el servicio de informática o tu grupo de investigación suelen tener máquinas Linux con SSH para alumnos | gratis; pídelo |
| **Servidor de un profesor** | acceso temporal a una máquina del departamento | gratis, con permiso |
| **Nube, capa gratuita** | varias nubes regalan una VM pequeña permanente o por meses (Oracle Cloud, Google Cloud, AWS…) | gratis con tarjeta de por medio: lee la letra pequeña |
| **Shell público** | comunidades que ofrecen cuentas SSH gratuitas (SDF, los *tildes*) | gratis; para practicar |
...
encontrarla terminada — `tmux`, la sesión que no muere. Y el caso
estrella del físico computacional: un Jupyter corriendo en el
servidor, abierto en el navegador de tu portátil a través de un túnel
SSH. De postre, qué es «la nube» en dos párrafos y qué es SLURM en
dos páginas: la puerta al doctorado. Guarda `sesion11.log`.
:::
