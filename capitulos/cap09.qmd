...
Hoy has hablado con números; el capítulo 10 les pone nombre: qué pasa
exactamente al escribir `debian.org` — el DNS, la guía telefónica de
internet —, el camino paquete a paquete hasta la universidad con
`traceroute`, por qué SSH es el puerto 22 y la web el 443, y los
primeros cambios *reversibles* en el router, con su vuelta atrás
escrita antes de tocar. Guarda `sesion09.log`.
:::
